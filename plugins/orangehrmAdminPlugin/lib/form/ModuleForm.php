...
class ModuleForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'payroll' => new sfWidgetFormInputCheckbox(array(), array('class' => 'checkbox', 'value' => 'on')),
    ...
    protected function _getDefaultValues() {
        ...
        $modules = array('admin', 'pim', 'leave', 'time', 'recruitment', 'payroll', 'performance');
